const {  generateTextureImgFromPrompt, textToImage, generateTexturesFromPrompts, textToImageOpenAi, characterCreationOptionPrompt} = require("./api.js");
const { characterCreationFlow } = require("../../character/utils.js")
...
async function main() {
    ...
    optionsMock = {
        ...
        for (const choice of choices) {
            const sessionId = 3;
            const boo = await characterCreationFlow(sessionId, choice, optionsMock);
            console.log('asdf')
        }
