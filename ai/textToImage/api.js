...
async function textToImageOpneAi(prompt, samples=1, localPath){
...
function characterCreationOptionPrompt(cardStats){
  const {title, font, illustration, description, texture} = cardStats;
  return `Create a full-frame illustration for the front side of a virtual RPG character creation card. The card, 
  titled '${title}' in ${font} font. (and this is the ONLY readable text in this illustration). 
